...
class DetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    //final DetailScreen agrs = ModalRoute.of(context).settings.arguments;
    return Scaffold(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        ServiceTile(serviceList[0], stylist),
                        ServiceTile(serviceList[1], stylist),
                        ServiceTile(serviceList[2], stylist),
                        ServiceTile(serviceList[3], stylist),
                        /* ClipRRect(
...
class ServiceTile extends StatelessWidget {
  final service;
  final stylist;
  ServiceTile(this.service, this.stylist);
        ...
        children: <Widget>[
          ...
          MaterialButton(
            onPressed: () async {
              ...
              db.child("Appoinment").push().set({
                "Data": "Dhruv",
                "StylishName": stylist['stylistName'],
                "Title": service['title'],
